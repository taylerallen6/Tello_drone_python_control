...
controls = {
    ...
    'left': lambda drone, speed: drone.counter_clockwise(speed*3),
    'right': lambda drone, speed: drone.clockwise(speed*3),
    ...
    '1': lambda drone, speed: drone.flip_forward(),
    '2': lambda drone, speed: drone.flip_back(),
    '3': lambda drone, speed: drone.flip_right(),
    '4': lambda drone, speed: drone.flip_left(),
    '5': lambda drone, speed: drone.flip_forwardright(),
    '6': lambda drone, speed: drone.flip_forwardleft(),
    '7': lambda drone, speed: drone.flip_backright(),
    '8': lambda drone, speed: drone.flip_backleft(),
}
